...
//add by xuwang
#define WARNING_OUT_HTTP "%s:%s/data/api/pyapi/warning/add"
#define REBOOT_OUT_HTTP "%s:%s/data/api/pyapi/camera/switch?status=C"
#define SWITCH_GET_HTTP "%s:%s/data/api/pyapi/camera/switch"
#define SWITCH_GET_HTTP_C "%s:%s/data/api/pyapi/camera/switch?status=C"

#define TOSERVICES_HTTP_DEFAULT_URL "http://127.0.0.1"
#define TOSERVICES_HTTP_DEFAULT_URL2 "http://192.168.2.46"
#define TOSERVICES_HTTP_DEFAULT_PORT 8088
